...
const { createMatch , startMatch , addBall , deleteMatch , changeBowler , endInnings , startInnings2 , getScorecard} = require("../controllers/matchController");
...
router.get("/:matchId/scorecard", authMiddleware, getScorecard);
